...
export default async () => {
  const t = {
    ...
    ['./modules/core/dtos/card.dto']: await import(
      './modules/set/dto/card.dto'
    ),
    ...
    '@nestjs/swagger': {
      models: [
        ...
        [
          ...
          {
            AbstractEntity: { createdAt: { required: true, type: () => Date } },
        ...
        [
          import('./modules/set/entities/card.entity'),
          {
            CardEntity: {
              ...
              correctCount: { required: false, type: () => Number },
              set: {
                required: true,
                type: () => t['./modules/set/entities/set.entity'].SetEntity,
              },
        ...
        [
          import('./modules/set/entities/set.entity'),
          {
            SetEntity: {
              ...
              passcode: { required: false, type: () => String },
              cards: {
                required: true,
                type: () => [
        ...
        [
          import('./modules/set/dto/card.dto'),
          {
            CardDto: {
              term: { required: true, type: () => String },
              definition: { required: true, type: () => String },
        ...
        [
          import('./modules/core/dtos/core.dto'),
          {
            ConvertFromTextDto: {
        ...
        [
          import('./modules/folder/folder.dto'),
          {
            ...
            UpdateFolderDto: {},
            AddSetsDto: { setIds: { required: true, type: () => [String] } },
            RemoveSetsDto: {},
          },
        ],
        [
          import('./modules/set/set.dto'),
          {
            CreateSetDto: {
              ...
              cards: {
                required: true,
                type: () => [t['./modules/core/dtos/card.dto'].CardDto],
              },
            },
            UpdateSetDto: {},
            StartLearningDto: {
            ...
            SetMetadataDto: {
              totalCards: { required: true, type: () => Number },
              notStudiedCount: { required: true, type: () => Number },
              learningCount: { required: true, type: () => Number },
              knownCount: { required: true, type: () => Number },
            },
            SetDetailDto: {
              set: {
                required: true,
              ...
              metadata: {
                required: true,
                type: () => t['./modules/set/set.dto'].SetMetadataDto,
              },
            },
          },
        ],
      ...
      controllers: [
        ...
        [
          import('./modules/core/core.controller'),
          {
            CoreController: {
              convertFromText: {
                type: [t['./modules/core/dtos/card.dto'].CardDto],
        ...
        [
          import('./modules/set/set.controller'),
          {
            SetController: {
              ...
              findOneAndMetadata: {
                type: t['./modules/set/set.dto'].SetDetailDto,
              },
              saveAnswer: {},
              startLearning: {
                type: t['./modules/set/entities/set.entity'].SetEntity,
