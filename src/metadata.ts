...
export default async () => {
  const t = {
    ...
    ['./modules/set/entities/set.entity']: await import(
      './modules/set/entities/set.entity'
    ),
    ['./modules/set/set.enum']: await import('./modules/set/set.enum'),
    ['./modules/set/entities/card.entity']: await import(
      './modules/set/entities/card.entity'
    ),
    ['./modules/folder/folder.entity']: await import(
      './modules/folder/folder.entity'
    ),
    ['./modules/set/set.dto']: await import('./modules/set/set.dto'),
    ['./modules/set/entities/study.entity']: await import(
      './modules/set/entities/study.entity'
    ),
    ['./modules/set/entities/practice.entity']: await import(
      './modules/core/entities/practice.entity'
    ),
  ...
  return {
    '@nestjs/swagger': {
      models: [
          ...
          import('./modules/user/entities/user.entity'),
          {
            UserEntity: {
              ...
              studies: {
                required: true,
                type: () => [
                  t['./modules/set/entities/practice.entity'].StudyEntity,
                ],
              },
            },
          },
        ...
        [
          import('./modules/folder/folder.dto'),
          {
            CreateFolderDto: {
            ...
            UpdateFolderDto: {},
            AddSetsDto: { setIds: { required: true, type: () => [Number] } },
            RemoveSetsDto: {},
          },
        ],
        [
          import('./modules/set/entities/card.entity'),
          {
            CardEntity: {
              id: { required: true, type: () => Number },
              ...
              set: {
                required: true,
                type: () => t['./modules/set/entities/set.entity'].SetEntity,
              },
            },
          },
        ],
        [
          import('./modules/set/entities/set.entity'),
          {
            SetEntity: {
              id: { required: true, type: () => Number },
              name: { required: true, type: () => String },
              ...
              visibleTo: {
                required: true,
                enum: t['./modules/set/set.enum'].VisibleTo,
              },
              visibleToPassword: { required: false, type: () => String },
              editableBy: {
                required: true,
                enum: t['./modules/set/set.enum'].EditableBy,
              },
              editableByPassword: { required: false, type: () => String },
              cards: {
                required: true,
                type: () => [
                  t['./modules/set/entities/card.entity'].CardEntity,
                ],
              },
              folder: {
                required: true,
                type: () => t['./modules/folder/folder.entity'].FolderEntity,
              },
            },
          },
        ],
        [
          import('./modules/folder/folder.entity'),
          {
            FolderEntity: {
              id: { required: true, type: () => Number },
              name: { required: true, type: () => String },
        ...
        [
          import('./modules/set/set.dto'),
          {
            ...
            CreateSetDto: {
              ...
              visibleToPassword: { required: true, type: () => String },
              editableBy: {
                required: true,
                enum: t['./modules/set/set.enum'].EditableBy,
              },
              editableByPassword: { required: true, type: () => String },
              cards: {
                required: true,
                type: () => [t['./modules/set/set.dto'].CardDto],
              },
            },
            FindOneSetDto: {
              visibleToPassword: { required: false, type: () => String },
        ...
        [
          import('./modules/set/entities/study.entity'),
          {
            StudyEntity: {
              id: { required: true, type: () => Number },
              user: {
        ...
        [
          import('./modules/core/entities/practice.entity'),
          {
            StudyEntity: {
              id: { required: true, type: () => Number },
              user: {
      ...
      controllers: [
        [
          import('./modules/auth/auth.controller'),
          {
            AuthController: {
              ...
              logout: {
                type: t['./modules/user/entities/session.entity'].SessionEntity,
              },
              refreshToken: {
        ...
        [
          import('./modules/folder/folder.controller'),
          {
            FolderController: {
              create: {
                type: t['./modules/folder/folder.entity'].FolderEntity,
        ...
        [
          import('./modules/set/set.controller'),
          {
            SetController: {
              findAll: {},
              findOnePublic: {
              ...
              convertFromText: { type: [t['./modules/set/set.dto'].CardDto] },
              create: {
                type: t['./modules/set/entities/set.entity'].SetEntity,
              },
              findMySets: {},
              ...
              convertFromXlsx: { type: [t['./modules/set/set.dto'].CardDto] },
            },
          },
        ],
        [
